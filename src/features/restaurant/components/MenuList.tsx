...
import { ActivateMenu } from "../hooks/hooks";
...
export const MenuList = ({
    ...
    onViewMenu,
    viewedMenuId,
    onMenuActivated, // callback to refresh after activation (required)
    idRestaurant,    // pass idRestaurant here!
}) => {
    // Handle activation of the menu
    const handleActivate = async (idMenu) => {
        await ActivateMenu(idMenu, idRestaurant);
        if (onMenuActivated) onMenuActivated();
    };
