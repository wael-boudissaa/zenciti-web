    ...
    <div className="bg-white rounded-xl shadow-sm p-5 mb-6">
      <div className="flex flex-wrap justify-between items-center mb-4">
        ...
        <button 
          ...
          className="text-sm text-primary font-medium hover:text-primary/70 transition"
        >
          Clear All
        </button>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="flex items-end">
          <button 
            ...
            className="w-full bg-primary hover:bg-primary/90 text-white py-2 px-4 rounded-lg text-sm font-medium transition"
          >
            Apply Filters
          </button>
        </div>
