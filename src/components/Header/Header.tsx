  ...
  <header className="bg-white p-6 shadow-sm flex justify-between items-center">
    ...
    <div className="flex items-center space-x-4">
      ...
      <div className="flex items-center space-x-2">
        <div className="w-10 h-10 rounded-full bg-green-900 flex items-center justify-center text-white font-semibold">IR</div>
        <div>
          <p className="font-medium text-gray-800">Indrit Restaurant</p>
